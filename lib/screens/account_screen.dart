      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text('QAZAQSHA', style: TextStyle(
                color: AppColors.gold, fontWeight: FontWeight.w900, letterSpacing: 2,
              )),
              const SizedBox(height: 35),
              const Text('Создать аккаунт', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w900)),
              const SizedBox(height: 10),
              const Text('Сохрани свой прогресс и начни свой путь в Qazaqsha.',
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Придумайте ник',
                  hintText: 'Например, Adil',
                  filled: true,
                  fillColor: AppColors.card,
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(18), borderSide: BorderSide.none),
                ),
              ...
              SizedBox(
                ...
                child: FilledButton(
                  ...
                  child: Text(
                    saving ? 'Сохраняем…' : 'Создать аккаунт',
